 ...
 * x n  integer matrix  heights  where  heights[r][c]  represents the  height
 ...
 *  Return  a  2D list  of grid coordinates   result   where   result[i] = [r
 * i , c i ]   denotes that rain water can flow from cell   (r i , c i )   to
