...
- <a id="lc-133"></a>🟡 [x] **[LC 133](src/cpp/graphs/133.clone-graph.cpp)**: [Clone Graph](https://leetcode.com/problems/clone-graph/)  
...
- `./run -e 1` : **vector** (Dynamic Array)
  ...
  int main() {
    ...
    vector<int> v4(v1.rbegin(), v1.rbegin() + 3);
    vector<int> v5(10, 2);
    // v5.reserve(10);
    // v5[0] = 100;
    cout << v5[0] << endl;
    ...
    cout << "after v5 capacity:" << v5.capacity() << endl;
    cout << "v5 size:" << v5.size() << endl;
    ...
    v1.reserve(
        20);      // Pre-allocates memory for 20 elements (prevents reallocations)
    ...
    cout << "Index 2 (safe): " << v1.at(2)
         << endl;                            // Bounds checking (throws exception)
    ...
    v1.emplace_back(
        88);       // Constructs element in-place at the end (faster for objects)
